...
<body>
    ...
    <div class="container">
        ...
        <section class="shopping-cart">
            ...
            <h1 class="heading">Ghorergarage</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    $select_cart = mysqli_query($connection, "SELECT * FROM cart WHERE user = '$session_username'");
                    $grand_total = 0;
                    ...
                    <tr class="table-bottom">
                        <td><a href="./buy_parts.php" class="option-btn" style="margin-top: 0;">continue shopping</a>
                        </td>
            ...
            <div class="checkout-btn">
                <a href="checkout.php" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>">procced to
                    checkout</a>
            </div>
